    ...
    if (!Function.prototype.bind) {
        Function.prototype.bind = function (j) {
            ...
            var n = Array.prototype.slice.call(arguments, 1),
                ...
                k = function () {},
                l = function () {
                    return m.apply(this instanceof k && j ? this : j || f, n.concat(Array.prototype.slice.call(arguments)))
                };
    ...
    if (typeof g.addEventListener == "undefined") {
        [f, g].forEach(function (j) {
            ...
            j.removeEventListener = function () {
                // i.removeEventListener.call(j, eventType, funcHandle, useCapture)
            }
        })
    }
    if (!g.createEvent) {
        g.createEvent = function (j) {
            ...
            switch (j) {
                ...
                case "MouseEvents":
                    k = {
                        initMouseEvent: function (p, z, q, y, u, s, r, o, m, n, l, x, w, t, v) {
                            k.type = p;
                            k.canBubble = z || false;
 ...
 */
(function (aw) {
    var E, az, l, u, N, Q, ac, aD, O, ad, af, I, v, ao, aj, ax, k, L, aq = "sizzle" + -(new Date()),
        P = aw.document,
        aA = 0,
        ak = 0,
        d = G(),
    ...
    af = C.setDocument = function (aE) {
        var e, aF = aE ? aE.ownerDocument || aE : P,
            i = aF.defaultView;
        ...
        if ((az.matchesSelector = V.test((k = v.webkitMatchesSelector || v.mozMatchesSelector || v.oMatchesSelector || v.msMatchesSelector)))) {
            m(function (aG) {
        ...
        L = e || V.test(v.contains) ? function (aH, aG) {
            var aJ = aH.nodeType === 9 ? aH.documentElement : aH,
                aI = aG && aG.parentNode;
        ...
        K = e ? function (aH, aG) {
            ...
            var aN, aK = 0,
                ...
                aL = [aG];
            if (!aM || !aJ) {
                return aH === aF ? -1 : aG === aF ? 1 : aM ? -1 : aJ ? 1 : O ? (j.call(O, aH) - j.call(O, aG)) : 0
            } else {
                if (aM === aJ) {
                    return f(aH, aG)
                }
    ...
    u = C.selectors = {
        ...
        filter: {
            ...
            CHILD: function (i, aG, aF, aH, aE) {
                var aJ = i.slice(0, 3) !== "nth",
                    e = i.slice(-4) !== "last",
                    aI = aG === "of-type";
                return aH === 1 && aE === 0 ? function (aK) {
                    return !!aK.parentNode
                } : function (aQ, aO, aT) {
                    var aK, aW, aR, aV, aS, aN, aP = aJ !== e ? "nextSibling" : "previousSibling",
                        aU = aQ.parentNode,
                        aM = aI && aQ.nodeName.toLowerCase(),
                        aL = !aT && !aI;
                    if (aU) {
                        if (aJ) {
                            while (aP) {
        ...
        return q(function (aS, aP, aK, aR) {
            ...
            if (aS) {
                if (aH || aE) {
                    ...
                    aQ = aO.length;
                    while (aQ--) {
                        if ((aM = aO[aQ]) && (aU = aH ? j.call(aS, aM) : aL[aQ]) > -1) {
                            aS[aU] = !(aP[aU] = aM)
                        }
                    }
                }
    ...
    function ar(aJ) {
        var aE, aH, aF, aI = aJ.length,
            aM = u.relative[aJ[0].type],
            aN = aM || u.relative[" "],
            aG = aM ? 1 : 0,
            aK = x(function (i) {
                return i === aE
        ...
        for (; aG < aI; aG++) {
            if ((aH = u.relative[aJ[aG].type])) {
                ...
                if (aH[aq]) {
                    ...
                    return n(aG > 1 && aC(e), aG > 1 && p(aJ.slice(0, aG - 1).concat({
                        value: aJ[aG - 2].type === " " ? "*" : ""
                    })).replace(y, "$1"), aH, aG < aF && ar(aJ.slice(aG, aF)), aF < aI && ar((aJ = aJ.slice(aF))), aF < aI && p(aJ))
                }
                e.push(aH)
            }
        }
    ...
    function ae(aF, aE) {
        var aH = 0,
            e = aE.length > 0,
            aG = aF.length > 0,
            i = function (aR, aL, aQ, aP, aU) {
                var aM, aN, aS, aW = 0,
                    aO = "0",
                    aI = aR && [],
                    aX = [],
                    aV = aD,
                    aK = aR || aG && u.find.TAG("*", aU),
                    aJ = (aA += aV == null ? 1 : Math.random() || 0.1),
                    aT = aK.length;
                if (aU) {
                    aD = aL !== I && aL;
                    l = aH
    ...
    function ay(aF, e, aG, aJ) {
        ...
        if (!aJ) {
            if (aI.length === 1) {
                ...
                if (aL.length > 2 && (aE = aL[0]).type === "ID" && az.getById && e.nodeType === 9 && ao && u.relative[aL[1].type]) {
                ...
                while (aH--) {
                    ...
                    if ((aK = u.find[aM])) {
                        if ((aJ = aK(aE.matches[0].replace(z, al), ah.test(aL[0].type) && Z(e.parentNode) || e))) {
                            aL.splice(aH, 1);
                            aF = aJ.length && p(aL);
                            if (!aF) {
                                b.apply(aG, aJ);
